...
public class ComprehentionResultStatusActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnCheck.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (getIntent().getStringExtra("type").equals("textonly")) {	
					Intent i = new Intent(ComprehentionResultStatusActivity.this, ComprehensionTextResultActivity.class);
					startActivity(i);
				} else if (getIntent().getStringExtra("type").equals("audioandtext")){
					Intent i = new Intent(ComprehentionResultStatusActivity.this, ComprehensionAudioResultActivity.class);
					startActivity(i);
				}
